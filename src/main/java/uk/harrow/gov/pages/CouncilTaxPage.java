...
public class CouncilTaxPage extends Utility {
    ...
    public void clickOnSinglePersonDiscountTab(){
        Reporter.addStepLog("Clicking on single person discount tab : " + singlePersonDiscount.toString());
        clickOnElement(singlePersonDiscount);
        log.info("Clicking on single person discount tab : " + singlePersonDiscount.toString());
    }

    public void clickOnApplyButton(){
        Reporter.addStepLog("Clicking on apply button : " + applyButton.toString());
        clickOnElement(applyButton);
        log.info("Clicking on apply button : " + applyButton.toString());
